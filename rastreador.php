                 ...
                 <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form id="formulario" method="POST" action="">
                            <fieldset>
                                <label>Nome: </label>
                                <input type="text" name="nomeUsu"><br>
                                						                                                             
                                <label>Telefone: </label>
                                <input type="text" name="telefoneUsu"><br>
                                
								<label>E-mail: </label>
                                <input type="text" name="emailUsu"><br>
                                
								<label>Login: </label>
                                <input type="text" name="loginUsu"><br>
								
								<label>Senha: </label>
                                <input type="password" name="senhaUsu"><br>
								<label>Tipo: </label>
								<select style="color:black"  name="nivel">
								<option name="nivel" value="1"> Administrador</option>
								<option name="nivel" value="2">	Cliente</option>
								</select>
								<br><br>
                                
                                <input type="submit" name="cadastrar" value="Cadastrar" style="background-color: #252525; border-radius: 5px; width:100px; height: 40px;color:white">  
                            </fieldset>
                        </form> 
                     </div>
